...
namespace UI
{
	...
	static void SET_TEXT_DROP_BLDR() { invoke<Void>(0x1CA3E9EAC9D93E5E); } // 0x1CA3E9EAC9D93E5E 0xE2A11511
	static void SET_TEXT_DROPBLDR(int distance, int r, int g, int b, int a) { invoke<Void>(0x465C84BC39F1C351, distance, r, g, b, a); } // 0x465C84BC39F1C351 0xE6587517
...
namespace GRAPHICS
{
	...
	static void _DRAW_LIGHT_WITH_RANGE_AND_BLDR(float x, float y, float z, int r, int g, int b, float range, float intensity, float BLDR) { invoke<Void>(0xF49E9A9716A04595, x, y, z, r, g, b, range, intensity, BLDR); } // 0xF49E9A9716A04595
	...
	static void _DRAW_SPOT_LIGHT_WITH_BLDR(float posX, float posY, float posZ, float dirX, float dirY, float dirZ, int colorR, int colorG, int colorB, float distance, float brightness, float roundness, float radius, float falloff, int BLDRId) { invoke<Void>(0x5BCA583A583194DB, posX, posY, posZ, dirX, dirY, dirZ, colorR, colorG, colorB, distance, brightness, roundness, radius, falloff, BLDRId); } // 0x5BCA583A583194DB 0x32BF9598
	...
	static void _SET_FAR_BLDRS_SUPPRESSED(BOOL toggle) { invoke<Void>(0x80ECBC0C856D3B0B, toggle); } // 0x80ECBC0C856D3B0B 0xFE903D0F
...
namespace ROPE
{
	...
	static void ROPE_DRAW_BLDR_ENABLED(Object* rope, BOOL toggle) { invoke<Void>(0xF159A63806BB5BA8, rope, toggle); } // 0xF159A63806BB5BA8 0x51523B8C
